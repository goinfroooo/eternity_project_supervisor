...
<head>
	...
	<title>Eternity_temperature</title>
</head>
<body>
...
<section>
	...
	<h1> Température salon</h1>

	<?php


// On récupère tout le contenu de la table jeux_video
$reponse = $bdd->query('SELECT * FROM temperature_maison');
...
while ($donnees = $reponse->fetch())
{
	...
	if ($donnees['Room']=='salon'){
?>



<p>
    <strong>Température : </strong> : <?php echo $donnees['Value']; ?>°
    le <?php echo $donnees['Date'];?> à <?php echo $donnees['Date'] ; ?>
